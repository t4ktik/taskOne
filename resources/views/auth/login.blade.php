    ...
    <div class="col-sm-8 col-lg-4">
        ...
        <div class="card shadow zindex-100 mb-0">
                    ...
                    <div class="form-group mb-0">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            @if (Route::has('password.request'))
                                <div class="mb-2">
                                    <a href="{{ route('password.request') }}" class="small text-muted text-underline--dashed border-primary">{{__('Lost password?')}}</a>
                                </div>
                            @endif
                        </div>
                        <div class="input-group input-group-merge">
            ...
            <div class="card-footer px-md-5"><small>{{__('Not registered?')}}</small>
                <a href="{{ route('register') }}" class="small font-weight-bold">{{__('Create account')}}</a>
            </div>
        </div>
    </div>
@endsection
