                    ...
                    <div class="card-body">
                        @foreach($home_data['project_status'] as $status => $val)
                            <div class="row align-items-center mb-4">
                                ...
                                <div class="col">
                                    <span class="d-block h6 mb-0">{{__(\App\Project::$status[$status])}}</span>
                                </div>
                            </div>
                        @endforeach
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="flex-fill pl-3 text-limit">
                                                    ...
                                                    <div class="d-flex justify-content-between text-xs text-muted text-right mt-1">
                                                        <div>
                                                            <span class="font-weight-bold text-{{ \App\Project::$status_color[$due_project->status] }}">{{ \App\Project::$status[$due_project->status] }}</span>
                                                        </div>
                                                        <div>
