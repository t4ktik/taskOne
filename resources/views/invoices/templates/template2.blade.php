                            ...
                            <div data-v-37eeda86="" class="d-inner">
                                <div data-v-37eeda86="" class="row">
                                    ...
                                    <div data-v-37eeda86="" class="col-2 text-right">
                                        <p data-v-37eeda86="">@if(\Auth::user()->name){{\Auth::user()->name}}@endif</p>
                                        <p data-v-37eeda86="">
                                    ...
                                    <div data-v-37eeda86="" class="col-33"><strong data-v-37eeda86="" class="tu mb5"
                                        ...
                                        <table data-v-37eeda86="" class="summary-table">
                                            ...
                                            <tr data-v-37eeda86="">
                                                ...
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{\App\Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                            ...
                                            <tr data-v-37eeda86="">
                                                ...
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{\Utility::getDateFormated($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-37eeda86="" class="d-table">
                                    <div data-v-37eeda86="" class="d-table">
                                        <div data-v-37eeda86="" class="tu d-table-tr" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 1px solid {{$color}}; border-top: 1px solid {{$color}};">
                                            ...
                                            <div class="d-table-th w-4 text-right">{{__('Tax')}}</div>
                                        </div>
                                                ...
                                                @foreach($invoice->items as $key => $item)
                                                    <div class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div class="d-table-td w-5">
                                                            <pre data-v-f2a183a6="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true)}}</pre>
                                                        </div>
                                                        <div class="d-table-td w-4 text-right"><span>{{\App\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                        ...
                                        <div data-v-37eeda86="" class="d-table-footer">
                                            ...
                                            <div class="d-table-summary">
                                                <div class="d-table-summary-item">
                                                    ...
                                                    <div
                                                        class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                </div>
                                                @if($invoice->getTax())
                                                    <div class="d-table-summary-item">
                                                        ...
                                                        <div class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                    </div>
                                                @endif
                                                <div class="d-table-summary-item"
                                                     style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    <div class="tu d-table-label">{{__('Total')}}:</div>
                                                    <div class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</div>
                                                </div>
                                                <div class="d-table-summary-item"
                                                     style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    <div class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
