                        ...
                        <div data-v-1ad6e3b9="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box">
                                    <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9="" src="{{$img}}" class="d-logo" style="max-width: 200px;"> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <p data-v-1ad6e3b9="">@if(\Auth::user()->name){{\Auth::user()->name}}@endif</p>
                                        <pre data-v-1ad6e3b9="">@if($left_address['address']){{$left_address['address']}}@endif</pre>
                                        <p data-v-1ad6e3b9="">@if($left_address['city']) {{$left_address['city']}}, @endif @if($left_address['state']){{$left_address['state']}}@endif @if($left_address['zipcode']) - {{$left_address['zipcode']}}@endif</p>
                                        <p data-v-1ad6e3b9="">@if($left_address['country']) {{$left_address['country']}}@endif</p>
                                    </div>
                                    ...
                                    <div data-v-1ad6e3b9="" class="col-33"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('INVOICE')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="summary-table">
                                            ...
                                            <tr data-v-1ad6e3b9="">
                                                ...
                                                <td data-v-1ad6e3b9="" class="text-right">{{\App\Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                            ...
                                            <tr data-v-1ad6e3b9="">
                                                ...
                                                <td data-v-1ad6e3b9="" class="text-right">{{\Utility::getDateFormated($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div data-v-1ad6e3b9="" class="row">
                                        <div data-v-1ad6e3b9="" class="col-2">
                                            <div data-v-1ad6e3b9="" class="col-66">
                                                ...
                                                <strong data-v-1ad6e3b9="" class="sub-title">@if($invoice->client_id == Auth::user()->id)
                                                        {{ $invoice->user->name }}
                                                    @else
                                                        {{ $invoice->client->name }}
                                                    @endif</strong>
                                                <pre data-v-1ad6e3b9="">@if($right_address['address']){{$right_address['address']}}@endif</pre>
                                                <p data-v-1ad6e3b9="">@if($right_address['city']) {{$right_address['city']}}, @endif @if($right_address['state']){{$right_address['state']}}@endif @if($right_address['zipcode']) - {{$right_address['zipcode']}}@endif</p>
                                                <p data-v-1ad6e3b9="">@if($right_address['country']) {{$right_address['country']}}@endif</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div data-v-1ad6e3b9="" class="d-table">
                                        <div data-v-1ad6e3b9="" class="d-table">
                                            <div data-v-1ad6e3b9="" class="tu d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-th w-5" style="padding: 5px;">{{__('Price')}}</div>
                                                <div data-v-1ad6e3b9="" class="d-table-th w-3 text-right" style="padding: 5px;">{{__('Tax')}}</div>
                                            </div>
                                                ...
                                                @if(isset($invoice->items) && count($invoice->items) > 0)
                                                    @foreach($invoice->items as $key => $item)
                                                        <div data-v-1ad6e3b9="" class="d-table-tr">
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-3" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$key+1}}</span></div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-13" style="border: 1px solid {{$color}}; padding: 5px;">
                                                                <pre data-v-1ad6e3b9="">{{$item->item}}<br data-v-1ad6e3b9=""></pre>
                                                            </div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-5" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true) }}</span></div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-3 text-right" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true) }}</span></div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-1ad6e3b9="" class="d-table-tr">
                                                        ...
                                                        <div data-v-1ad6e3b9="" class="d-table-td w-13" style="border: 1px solid {{$color}}; padding: 5px;">
                                                            <pre data-v-1ad6e3b9="">-<br data-v-1ad6e3b9=""></pre>
                                                        </div>
                                                        <div data-v-1ad6e3b9="" class="d-table-td w-5" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">-</span></div>
                                                        <div data-v-1ad6e3b9="" class="d-table-td w-3 text-right" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
                                            <div data-v-1ad6e3b9="" class="d-table-footer">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-summary">
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-1ad6e3b9="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                    </div>
                                                    @if($invoice->getTax())
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            <div data-v-1ad6e3b9="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                            <div data-v-1ad6e3b9="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label"><strong data-v-1ad6e3b9="">{{__('Total')}}:</strong></div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value"><strong data-v-1ad6e3b9="">{{\App\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</strong></div>
                                                    </div>
                                                    <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                        <div data-v-1ad6e3b9="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                        <div data-v-1ad6e3b9="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
