                            ...
                            <div data-v-b8f60a0c="" class="d-inner">
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('From')}}:</strong>
                                        <p data-v-b8f60a0c="">@if(\Auth::user()->name){{\Auth::user()->name}}@endif</p>
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-2">
                                        <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('To')}}:</strong>
                                            <p data-v-b8f60a0c="">@if($invoice->client_id == Auth::user()->id)
                                                    {{ $invoice->user->name }}
                                                @else
                                                    {{ $invoice->client->name }}
                                                @endif</p>
                                            ...
                                            @if(isset($invoice->items) && count($invoice->items) > 0)
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-b8f60a0c="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-b8f60a0c="" class="d-table-td w-5"><span data-v-b8f60a0c="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true) }}</span></div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-3 text-right"><span data-v-b8f60a0c="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true) }}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-b8f60a0c="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                        ...
                                        <div data-v-b8f60a0c="" class="d-table-footer">
                                            ...
                                            <div data-v-b8f60a0c="" class="d-table-summary">
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                </div>
                                                @if($invoice->getTax())
                                                    <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                        <div data-v-b8f60a0c="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-b8f60a0c="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-b8f60a0c="" class="d-table-summary-item" style="color: {{$font_color}}; background: {{$color}};">
                                                    ...
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</div>
                                                </div>
                                                <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                    <div data-v-b8f60a0c="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-b8f60a0c="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
