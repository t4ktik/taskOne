                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        ...
                                        <p data-v-f2a183a6="">@if(\Auth::user()->name){{\Auth::user()->name}}@endif</p>
                                        <p data-v-f2a183a6="">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                <td>{{__('Number')}}:</td>
                                                <td>{{\App\Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Project')}}:</td>
                                                    ...
                                                    @foreach($invoice->items as $key => $item)
                                                        <div class="d-table-tr" style="border-bottom:1px solid {{$border_color}};">
                                                            ...
                                                            <div class="d-table-td w-5 text-right">
                                                                <pre data-v-f2a183a6="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true) }}</pre>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                    </div>
                                                    @if($invoice->getTax())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$border_color}}; border-bottom: 1px solid {{$border_color}};">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$border_color}}; border-bottom: 1px solid {{$border_color}};">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Due Amount')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
