                            ...
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        <img data-v-e23d9750="" src="{{$img}}" class="d-logo">
                                        <div data-v-e23d9750="" class="break-25"></div>
                                        <p data-v-e23d9750="">@if(\Auth::user()->name){{\Auth::user()->name}}@endif</p>
                                        <pre data-v-e23d9750="">@if($left_address['address']){{$left_address['address']}}@endif</pre>
                                        <p data-v-e23d9750="">@if($left_address['city']) {{$left_address['city']}}, @endif @if($left_address['state']){{$left_address['state']}}@endif @if($left_address['zipcode']) - {{$left_address['zipcode']}}@endif</p>
                                        <p data-v-e23d9750="">@if($left_address['country']){{$left_address['country']}}@endif</p>
                                    </div>
                                </div>
                                ...
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><strong data-v-e23d9750="" class="tu mb5">{{__('Bill To')}}:</strong>
                                        <p data-v-e23d9750="">@if($invoice->client_id == Auth::user()->id)
                                                {{ $invoice->user->name }}
                                            @else
                                                {{ $invoice->client->name }}
                                            @endif</p>
                                        <pre data-v-e23d9750="">@if($right_address['address']){{$right_address['address']}}@endif</pre>
                                        <p data-v-e23d9750="">@if($right_address['city']) {{$right_address['city']}}, @endif @if($right_address['state']){{$right_address['state']}}@endif @if($right_address['zipcode']) - {{$right_address['zipcode']}}@endif</p>
                                        <p data-v-e23d9750="">@if($right_address['country']){{$right_address['country']}}@endif</p>
                                    </div>
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-e23d9750="">
                                                ...
                                                <td data-v-e23d9750="" class="text-right">{{\App\Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                            ...
                                            <tr data-v-e23d9750="">
                                                ...
                                                <td data-v-e23d9750="" class="text-right">{{\Utility::getDateFormated($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-e23d9750="" class="d-table">
                                    <div data-v-e23d9750="" class="d-table">
                                        <div data-v-e23d9750="" class="tu d-table-tr" style="border-bottom: 2px solid {{$color}};">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-th w-5">{{__('Price')}}</div>
                                            <div data-v-e23d9750="" class="d-table-th w-3 text-right">{{__('Tax')}}</div>
                                        </div>
                                                ...
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-e23d9750="" class="d-table-tr">
                                                        ...
                                                        <div data-v-e23d9750="" class="d-table-td w-13">
                                                            <pre data-v-e23d9750="">{{$item->item}}<br data-v-e23d9750=""></pre>
                                                        </div>
                                                        <div data-v-e23d9750="" class="d-table-td w-5"><span data-v-e23d9750="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true) }}</span></div>
                                                        <div data-v-e23d9750="" class="d-table-td w-3 text-right"><span data-v-e23d9750="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true) }}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-e23d9750="" class="d-table-tr">
                                        ...
                                        <div data-v-e23d9750="" class="d-table-footer">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-summary">
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-e23d9750="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                </div>
                                                @if($invoice->getTax())
                                                    <div data-v-e23d9750="" class="d-table-summary-item">
                                                        <div data-v-e23d9750="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-e23d9750="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="fwb f-b tu d-table-label">{{__('Total')}}:</div>
                                                    <div data-v-e23d9750="" class="fwb f-b d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</div>
                                                </div>
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-e23d9750="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
