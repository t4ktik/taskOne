                            ...
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        ...
                                        <strong data-v-4b3dcb8a="" class="sub-title">@if(\Auth::user()->name){{\Auth::user()->name}}@endif</strong>
                                        <pre data-v-4b3dcb8a="">@if($left_address['address']){{$left_address['address']}}@endif</pre>
                                        <p data-v-4b3dcb8a="">@if($left_address['city']) {{$left_address['city']}}, @endif @if($left_address['state']){{$left_address['state']}}@endif @if($left_address['zipcode']) - {{$left_address['zipcode']}}@endif</p>
                                        <p data-v-4b3dcb8a="">@if($left_address['country']) {{$left_address['country']}}@endif</p>
                                    </div>
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        <div data-v-4b3dcb8a="" class="col-66">
                                            <small data-v-4b3dcb8a="">{{__('To')}}:</small>
                                            <strong data-v-4b3dcb8a="" class="sub-title">@if($invoice->client_id == Auth::user()->id)
                                                    {{ $invoice->user->name }}
                                                @else
                                                    {{ $invoice->client->name }}
                                                @endif</strong>
                                            <pre data-v-4b3dcb8a="">@if($right_address['address']){{$right_address['address']}}@endif</pre>
                                            <p data-v-4b3dcb8a="">@if($right_address['city']) {{$right_address['city']}}, @endif @if($right_address['state']){{$right_address['state']}}@endif @if($right_address['zipcode']) - {{$right_address['zipcode']}}@endif</p>
                                            <p data-v-4b3dcb8a="">@if($right_address['country']) {{$right_address['country']}}@endif</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-33">
                                        <table data-v-4b3dcb8a="" class="summary-table">
                                            ...
                                            <tr data-v-4b3dcb8a="">
                                                ...
                                                <td data-v-4b3dcb8a="" class="text-right">{{\App\Utility::invoiceNumberFormat($invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                            ...
                                            <tr data-v-4b3dcb8a="">
                                                ...
                                                <td data-v-4b3dcb8a="" class="text-right">{{\Utility::getDateFormated($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-4b3dcb8a="" class="d-table">
                                    <div data-v-4b3dcb8a="" class="d-table">
                                        <div data-v-4b3dcb8a="" class="tu d-table-tr" style="background: {{$color}}; padding: 5px;color: {{$font_color}}">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-th w-5">{{__('Price')}}</div>
                                            <div data-v-4b3dcb8a="" class="d-table-th w-3 text-right">{{__('Tax')}}</div>
                                        </div>
                                                ...
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-13">
                                                            <pre data-v-4b3dcb8a="">{{$item->item}}<br data-v-4b3dcb8a=""></pre>
                                                        </div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-5"><span data-v-4b3dcb8a="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true) }}</span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-3 text-right"><span data-v-4b3dcb8a="">{{ \App\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true) }}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-td w-5"><span data-v-4b3dcb8a="">-</span></div>
                                        ...
                                        <div data-v-4b3dcb8a="" class="d-table-footer">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-summary">
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                </div>
                                                @if($invoice->getTax())
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label"><strong data-v-4b3dcb8a="">{{__('Total')}}:</strong></div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><strong data-v-4b3dcb8a="">{{\App\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</strong></div>
                                                </div>
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value">{{\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
