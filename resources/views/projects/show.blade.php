...
@section('action-button')
    <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
        ...
        <a href="{{ route('projects.gantt',$project->id) }}" class="btn btn-sm bg-white btn-icon rounded-pill ml-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <span class="h4 font-weight-bold mb-0 ">{{ \App\Utility::projectCurrencyFormat($project->id,$project_data['expense']['total']) }}</span>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <span class="text-sm text-muted">{{ __('Total Budget').' : '.\App\Utility::projectCurrencyFormat($project->id,$project_data['expense']['allocated']) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            <h6 class="text-sm d-block text-limit mb-0">{{ $milestone->title }}
                                                <span class="badge badge-pill badge-{{\App\Project::$status_color[$milestone->status]}}">{{ __(\App\Project::$status[$milestone->status]) }}</span>
                                            </h6>
