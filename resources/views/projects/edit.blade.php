                    ...
                    <div data-href="#tabs-2" class="list-group-item">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="mb-0 text-sm">{{__('Faster checkout with saved addresses')}}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        @foreach(\App\Project::$status as $k => $v)
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <img {{ $project->img_image }} alt="{{ $project->name }}" class="avatar avatar-xl"/>
                                            ...
                                            <tr>
                                                ...
                                                <td class="action text-right">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input email-template-checkbox" id="email_tempalte_{{$template->id}}" @if($template->is_active == 1) checked="checked" @endcan type="checkbox" value="{{$template->is_active}}" data-url="{{route('status.email.language',[$template->id,$project->id])}}"/>
