                            ...
                            <div class="flex-fill pl-3 text-limit">
                                <div class="row">
                                    ...
                                    <div class="col-3 text-right">
                                        <span class="badge badge-xs badge-{{ (Auth::user()->checkProject($project->id) == 'Owner') ? 'success' : 'warning'  }}">{{ Auth::user()->checkProject($project->id) }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between text-xs text-muted text-right mt-1">
                                    <div>
                                        <span class="font-weight-bold text-{{ \App\Project::$status_color[$project->status] }}">{{ \App\Project::$status[$project->status] }}</span>
                                    </div>
                                    <div>
