...
class Project extends Model
{
    ...
    {
        return $this->belongsToMany('App\User', 'project_users', 'project_id', 'user_id')->withPivot('id', 'permission')->withTimestamps();
    }
    ...
    {
        return $this->hasMany('App\TaskStage', 'project_id', 'id');
    }
